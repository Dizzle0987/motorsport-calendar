...
I palinsesti Austria e Italia sono conservativi. Ogni 6 ore l'updater controlla le fonti ufficiali previste: palinsesto ORF 1, EPG ServusTV, pagine programmi Sky Sport/NOW e JSON EPG TV8. Per i successivi 35 giorni interroga sia ORF 1 sia ServusTV anche quando l'assegnazione stagionale provvisoria indica l'altro canale: una corrispondenza verificata per competizione, sessione, data e fascia oraria corregge automaticamente canale e orario. Se la pagina ufficiale austriaca non risponde o non contiene ancora la giornata richiesta, vengono consultate in ordine la guida server-rendered TVinfo e la guida giornaliera TVHeute, sempre nella pagina specifica per ORF 1 o ServusTV; la pagina esatta usata resta registrata nell'evento. Le assegnazioni stagionali già pubblicate vengono applicate per identità del Gran Premio, non per data, così uno spostamento non può invertire ORF e ServusTV: ORF 1 / ORF ON oppure ServusTV / ServusTV On in Austria, Sky Sport / NOW in Italia. L'orario sportivo della sessione non viene mai spacciato per orario d'inizio del programma televisivo: finché nessuna fonte pubblica una fascia verificabile, l'evento riporta «palinsesto da confermare». Per la MotoGP, le sessioni integrali disponibili soltanto nel flusso internazionale di ServusTV On sono indicate separatamente e non ricevono dati del palinsesto lineare. In Italia la priorità è TV8 in diretta, poi Sky Sport / NOW in diretta; TV8 in differita non sostituisce mai una diretta disponibile. In Austria viene rispettata l'assegnazione effettiva del GP, senza elencare insieme ORF e ServusTV. La corrispondenza richiede competizione, sessione, data e fascia oraria verificabili. Tutti gli orari pubblicati sono convertiti in `Europe/Rome`. Lo streaming può essere soggetto a limitazioni geografiche.
