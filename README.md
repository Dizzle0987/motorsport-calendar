...
I palinsesti Austria e Italia sono conservativi. Le assegnazioni stagionali ufficiali già pubblicate vengono applicate automaticamente: ORF 1 / ORF ON o ServusTV / ServusTV On in Austria, Sky Sport / NOW in Italia. L'orario sportivo della sessione non viene usato come sostituto dell'orario di trasmissione ORF: finché manca un palinsesto ORF specifico, l'evento riporta «palinsesto da confermare». Per la MotoGP, le sessioni integrali disponibili soltanto nel flusso internazionale di ServusTV On sono indicate separatamente. In Italia la priorità è TV8 in diretta, poi Sky Sport / NOW in diretta; TV8 in differita non sostituisce mai una diretta disponibile. TV8 viene selezionata soltanto con un palinsesto specifico verificabile. Lo streaming può essere soggetto a limitazioni geografiche.
